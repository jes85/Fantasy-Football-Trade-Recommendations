...
class TradeEnumerator {
  ...
  getAllTradesForTeam(team, otherTeams, currentWeek, numWeeksInSeason) {
    ...
    _.each(otherTeams, (otherTeam) => {
      var all1v1Trades = this.getAll1v1Trades(team, otherTeam, currentWeek, numWeeksInSeason); // getAllnvmTrades(Team1, Team2, 1, 1)

      var all2v2Trades = [];// this.getAll2v2Trades(team, otherTeam, currentWeek, numWeeksInSeason); // getAllnvmTrades(Team1, Team2, 2, 2)
